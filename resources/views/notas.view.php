...
<html>
<head>
<title>Calificaciones - Registro de calificaciones</title>
...
<nav>
    <ul>
        ...
        <li class="active"><a href="notas.view.php">Registro de calificaciones</a> </li>
...
<div class="body">
    <div class="panel">
            <h3>Registro y Modificación Calificaciones</h3>
           <?php
           if(!isset($_GET['revisar'])){
            ...
            <form method="get" class="form" action="notas.view.php">
                ...
                <br><br>
                <button type="submit" name="revisar" value="1">Ingresar calificaciones</button> <a class="btn-link" href="listadonotas.view.php">Consultar calificaciones</a>
                <br><br>
            </form>
        <?php
           }
        ...
        if(isset($_GET['revisar'])){
            ...
            $sqlalumnos = $conn->prepare("select a.id, a.num_lista, a.apellidos, a.nombres, b.nota, avg(b.nota) as promedio, b.observaciones from alumnos as a left join notas as b on a.id = b.id_alumno group by a.id");
            $sqlalumnos->execute();
