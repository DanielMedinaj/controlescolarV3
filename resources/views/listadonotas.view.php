...
<nav>
    <ul>
        ...
        <li class="active"><a href="listadonotas.view.php">Consulta de calificaciones</a> </li>
    ...
    <div class="panel">
        ...
        if(!isset($_GET['consultar'])){
            ...
            <form method="get" class="form" action="listadonotas.view.php">
                ...
                <br><br>
                <button type="submit" name="consultar" value="1">Consultar calificaciones</button></a>
                <br><br>
            </form>
            <?php
        }
        ...
        if(isset($_GET['consultar'])){
            ...
            $sqlalumnos = $conn->prepare("select a.id, a.num_lista, a.apellidos, a.nombres, b.nota,b.observaciones, avg(b.nota) as promedio from alumnos as a left join notas as b on a.id = b.id_alumno group by a.id");
            $sqlalumnos->execute();
